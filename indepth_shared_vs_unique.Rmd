---
title: "indepth_anlyis_shared_vs_unique"
...
# Comparison of shared vs unique TE families
1. Do shared or species-specific TE lineages dominate the TE signal in each species?
2. Is the dominance pattern the same for bp and for annotation counts?
3. Are between-species differences driven by shared or unique lineages?
4. Are species-specific superfamilies globally important or marginal?
...
## Since unique TEs constitute a higher percentage of the overall genome we look further into the shared ones ot answer: How does the same TE repertoire behave differently under different regulatory regimes (parasitic vs free-living)?
